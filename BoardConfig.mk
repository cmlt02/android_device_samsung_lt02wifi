...
TARGET_KERNEL_CONFIG := cm_lt02_defconfig
BOARD_KERNEL_CMDLINE := androidboot.harware=mrvl androidboot.selinux=permisive
...
#WIFI_DRIVER_MODULE_ARG := "firmware_path=/system/etc/firmware/mrvl/sd8777_uapsta.bin cfg80211_wext=12 sta_name=wlan uap_name=wlan wfd_name=p2p fw_name=mrvl/sd8777_uapsta.bin"3
